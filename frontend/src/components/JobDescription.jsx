...
const JobDescription = () => {
    ...
    const applyJobHandler = async () => {
      try{
        ...
        if(res.data.success){
          setIsApplied(true);
          const updateSingleJob = {...singleJob,applications:[...singleJob.applications,{applicant:user?.id}]};
      ...
      <div className='flex items-center justify-between'>
        <div>
            ...
            <div>
                ...
                <Badge className={"text-ingigo-600 font-bold"} variant={"ghost"}>{singleJob?.salary} LPA</Badge>
            </div>
        </div>
